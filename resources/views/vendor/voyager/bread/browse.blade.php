        ...
        @can('delete', app($dataType->model_name))
            @if ($usesSoftDeletes)
                <input type="checkbox" @if ($showSoftDeleted) checked @endif id="show_soft_deletes"
                    data-toggle="toggle" data-on="{{ __('bread.soft_deletes_off') }}"
                    ...
                    <div class="panel-body">
                        @if ($isServerSide)
                            <form method="get" class="form-search">
                                <div id="search-input">
                                    ...
                                    <div class="col-2">
                                        <select id="filter" name="filter">
                                            ...
                                            <option value="equals" @if ($search->filter == 'equals') selected @endif>Es
                                                Igual</option>
                                        </select>
                                    </div>
                                ...
                                @if (Request::has('sort_order') && Request::has('order_by') && Request::has('showSoftDeleted'))
                                    <input type="hidden" name="sort_order" value="{{ Request::get('sort_order') }}">
                                    <input type="hidden" name="order_by" value="{{ Request::get('order_by') }}">
                                    <input type="hidden" name="showSoftDeleted"
                                        value="{{ Request::get('showSoftDeleted') }}">
                                @endif
                            </form>
                        @endif
